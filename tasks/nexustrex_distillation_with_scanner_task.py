...
#
# nexustrex_distillation_with_scanner_task.py - Teacher–student distillation (WithScanner ablation)
# Teacher: basic-task checkpoint (includes height_scan)
# Student: includes height_scan for ablation vs. NoScanner
...
class MySceneCfg(InteractiveSceneCfg):
    """Distillation scene; both teacher and student use height_scanner."""
...
class ObservationsCfg:
    """Observation groups: teacher (MDP) and student (MDP-like)."""

    @configclass
    class TeacherPolicyCfg(ObsGroup):
        """Teacher observations — identical to basic."""
    ...
    class StudentPolicyCfg(ObsGroup):
        """Student observations with height_scan for ablation vs. NoScanner."""
...
@configclass
class RewardsCfg:
    """Aligned with the NoScanner version."""
...
@configclass
class NexusTrexDistillationWithScannerEnvCfg(ManagerBasedRLEnvCfg):
    """Teacher–student distillation environment configuration (WithScanner)."""
